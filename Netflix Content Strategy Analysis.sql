...
#9. Find each year and the Average number of contents released by US on Netflix and return top 5 year with highest Average content release.
SELECT 
...
#10. Categorize the content based on the presence of the keywords ‘kill’ and ‘violence’ in the description field. Label content contains these keywords as ‘bad’ and ‘good’ . count how many items fall in each category.
SELECT 
    CASE
